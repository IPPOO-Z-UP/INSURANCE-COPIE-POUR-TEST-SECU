      ...
      {enrollData && (
        <div>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <div className="p-2 bg-white rounded-xl border shrink-0" style={{ borderColor: "var(--line-hairline)" }}>
              {/* ✅ SECURITY: Generate QR code locally to avoid leaking the TOTP secret (otpauth URI) to third-party services */}
              <QRCodeSVG
                value={enrollData.otpauth}
                size={164}
                level="M"
              />
            </div>
