      ...
      {enrollData && (
        <div>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <div className="p-2 bg-white rounded-xl border" style={{ borderColor: "var(--line-hairline)" }}>
              <QRCodeSVG value={enrollData.otpauth} size={164} level="M" title="Code QR pour l'authentification à deux facteurs" />
            </div>
