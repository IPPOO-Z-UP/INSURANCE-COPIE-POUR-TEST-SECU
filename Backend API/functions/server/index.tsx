...
// Cryptographically secure random integer generation (replaces weak Math.random())
// to prevent prediction attacks on OTPs, passwords, and identifiers.
...
// Cryptographically secure suffix generation (replaces weak Math.random())
// to prevent ID and token enumeration or collision prediction.
