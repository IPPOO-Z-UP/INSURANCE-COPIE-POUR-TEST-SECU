...
/**
 * Returns a cryptographically secure random alphanumeric suffix.
 */
...
/**
 * Masks internal errors and logs them securely.
 */
function safeError(c: any, err: any, publicMessage = "Une erreur interne est survenue.", status = 500) {
  const errorId = `err_${Date.now()}_${secureRandomSuffix(4)}`;
  console.error(`[${errorId}]`, err);
  return c.json({ error: publicMessage, errorId }, status);
}
