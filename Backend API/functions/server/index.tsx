...
// Cryptographically secure random integer generation with rejection sampling (prevents modulo bias)
...
// Cryptographically secure random string generation (alphanumeric suffix)
