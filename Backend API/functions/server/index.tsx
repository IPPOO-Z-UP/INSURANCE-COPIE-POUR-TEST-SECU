...
// Security helper: mask internal error details and log them privately
function safeError(err: unknown, defaultMessage = "Une erreur interne est survenue. Réessayez plus tard."): { error: string } {
  console.error("Internal Server Error:", err);
  return { error: defaultMessage };
}

// Security helper: cryptographically secure random integers [min, max]
...
// Security helper: cryptographically secure random suffixes (alphanumeric, lowercase)
