...
/**
 * Masks internal errors and returns a generic French message to the client.
 * Logs the actual error for server-side debugging.
 */
...
/**
 * Generates a short cryptographically secure random suffix for IDs.
 */
function secureRandomSuffix(length: number = 5): string {
