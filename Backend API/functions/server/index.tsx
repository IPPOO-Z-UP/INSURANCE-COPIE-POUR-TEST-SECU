...
function safeError(c: any, message: string, error: any, status: number = 500) {
...
app.post(`${PREFIX}/phone/otp/send`, async (c) => {
  try {
    ...
    return safeError(c, "Erreur lors de l'envoi du code", err);
  }
});
app.post(`${PREFIX}/phone/otp/verify`, async (c) => {
  try {
    ...
    return safeError(c, "Erreur de vérification", err);
  }
});
...
app.put(`${PREFIX}/me`, async (c) => {
  ...
  try {
    ...
    return safeError(c, "Erreur de mise à jour du profil", err);
  }
});
